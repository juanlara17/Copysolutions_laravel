                    ...
                    <section id="projects">
                        <ul id="thumbs" class="portfolio">
                            ...
                            <li class="item-thumbs span3 photography" data-id="id-2" data-type="illustrator">
                                ...
                                <!-- Thumb Image and Description -->
                                <img src="{{ asset('images/services/img_1.jpg') }}" alt="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus quis elementum odio. Curabitur pellentesque, dolor vel pharetra mollis.">
                            </li>
                            <!-- End Item Project -->
                            <!-- Item Project and Filter Name -->
                            <li class="item-thumbs span3 photography" data-id="id-2" data-type="illustrator">
                                ...
                                <!-- Thumb Image and Description -->
                                <img src="{{ asset('images/services/marketing_1.jpg') }}" alt="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus quis elementum odio. Curabitur pellentesque, dolor vel pharetra mollis.">
                            </li>
                            <!-- End Item Project -->
                            <!-- Item Project and Filter Name -->
                            ...
                            <li class="item-thumbs span3 photography" data-id="id-5" data-type="icon">
                                ...
                                <!-- Thumb Image and Description -->
                                <img src="{{ asset('images/services/print4.jpg') }}" alt="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus quis elementum odio. Curabitur pellentesque, dolor vel pharetra mollis.">
                            </li>
                            <!-- End Item Project -->
                            <!-- Item Project and Filter Name -->
                            <li class="item-thumbs span3 photography" data-id="id-2" data-type="illustrator">
                            ...
                            <li class="item-thumbs span3 design" data-id="id-0" data-type="web">
                                ...
                                <!-- Thumb Image and Description -->
                                <img src="{{ asset('images/print1.jpeg') }}" alt="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus quis elementum odio. Curabitur pellentesque, dolor vel pharetra mollis.">
                            </li>
                            <!-- End Item Project -->
                        </ul>
                    </section>
